    ...
    public function index()
    {
        ...
        if (!$data['admin']) {
            ...
            $nilai_kriteria = array(
                ...
                array($skala[0]->nilai, 1, $skala[3]->nilai, $skala[4]->nilai),
                array($skala[1]->nilai, $skala[3]->nilai, 1, $skala[5]->nilai),
                array($skala[2]->nilai, $skala[4]->nilai, $skala[5]->nilai, 1)
            );
